...
namespace WeatherApp.Provider
{
    ...
    {
        private BaseWeatherData _weather;
        private SpeedUnit _speedUnit;

        public ApparentTemperatureCalculator(BaseWeatherData weather, SpeedUnit speedUnit)
        {
            _weather = weather;
        ...
        {
            if (unitOut == TemperatureUnit.Fahrenheit && unitIn == TemperatureUnit.Celsius)
            {
                return CelsiusToFahrenheit(temp);
            }
            else if (unitOut == TemperatureUnit.Celsius && unitIn == TemperatureUnit.Fahrenheit)
            {
